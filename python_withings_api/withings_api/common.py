...
class GetSleepSummaryField(Enum):
    ...
    APNEA_HYPOPNEA = "apnea_hypopnea_index"
...
class MeasureGetIntraActivityActivity(
    BaseModel
):  # pylint: disable=too-many-instance-attributes
    ...
    stroke: Optional[int]
    pool_lap: Optional[int]
    duration: Optional[float]
    heart_rate: Optional[int]
    spo2_auto : Optional[int]
...
class MeasureGetIntraActivityResponse(ConfiguredBaseModel):
    """MeasureGetIntraActivityResponse."""
    series: Tuple[MeasureGetIntraActivityActivity, ...]
